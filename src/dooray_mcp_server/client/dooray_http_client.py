...
from ..types.dooray_api_types import DoorayApiResponse, DoorayErrorResponse
...
class DoorayHttpClient(DoorayClient):
    ...
    def __init__(self, base_url: str, dooray_api_key: str):
        ...
        # Configure HTTP logging level
        http_log_level = os.getenv("DOORAY_HTTP_LOG_LEVEL", "WARN").upper()
